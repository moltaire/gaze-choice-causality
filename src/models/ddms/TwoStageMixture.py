...
class TwoStageMixture(TwoStagePyDDM):
    ...
    def compute_stage_two_drift(self, trial):
        ...
        drift = (
            (1 - w_between) * drift_within
            + w_between * self.agentVars.s_between * drift_between
            + last_stage_bias
        )
        return drift
    ...
    def build_model(self):
        ...
        model = Model(
            ...
            drift=TwoStageMixtureDrift(
                ...
                s_between=Fittable(minval=0, maxval=30),
...
class TwoStageMixtureDrift(Drift):
    ...
    def get_drift(self, conditions, **kwargs):
        ...
        drift = self.v * (
            (1 - w_between) * drift_within
            + w_between * self.s_between * drift_between
            + last_stage_bias
        )
